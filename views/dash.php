...
<title>BRAINBOX || DASHBOARD </title>
<link  rel="stylesheet" href="css_quiz/bootstrap.min.css"/>
 <link  rel="stylesheet" href="css_quiz/bootstrap-theme.min.css"/>    
 <link rel="stylesheet" href="css_quiz/main.css">
 <link  rel="stylesheet" href="css_quiz/font.css">
 <script src="js_quiz/jquery.js" type="text/javascript"></script>

  <script src="js_quiz/bootstrap.min.js"  type="text/javascript"></script>
...
<div class="row">
<div class="col-lg-6">
<span class="logo">Quiz System</span></div>
<?php
...
<nav class="navbar navbar-default title1">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="quiz.php?q=0"><b>Dashboard</b></a>
    </div>
...
<tr style="color:red"><td><b>Rank</b></td><td><b>Name</b></td><td><b>CourseCode_StudentID_Section</b></td><td><b>Score</b></td></tr>';
$c=0;
...
echo  '<div class="panel"><table class="table table-striped title1">
<tr><td><b>S.N.</b></td><td><b>Name</b></td><td><b>Gender</b></td><td><b>Course_Section_ID</b></td><td><b>Email</b></td><td><b>Mobile</b></td><td></td></tr>';
$c=1;
while($row = mysqli_fetch_array($result)) {
	$name = $row['name'];
	$mob = $row['mob'];
